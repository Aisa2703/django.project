...
class Category(models.Model):
    post = models.ManyToManyField(Post, related_name='categories', verbose_name='Post')
...
class Comment(models.Model):
    ...
    post = models.ForeignKey(Post, on_delete=models.CASCADE, related_name='comment_to_post', verbose_name='Post')
